...
@php
    ...
    $resolveUrl = function ($raw) {
        ...
        if (str_starts_with($raw, '/')) return asset(ltrim($raw, '/'));
...
<div class="max-w-6xl mx-auto py-6 sm:py-10">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <span class="inline-flex items-center gap-2 rounded-full bg-white border px-3 py-1 text-xs text-gray-700 shadow-sm">
    ...
    {{-- Success --}}
    @if(session('success'))
        <div class="mb-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-emerald-900 flex items-start gap-3">
    ...
    <form method="POST"
        ...
        {{-- Main Card --}}
        <div class="bg-white/80 backdrop-blur-xl border border-white/60 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden">
            {{-- Top Gradient Bar --}}
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 rounded-3xl border bg-white p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <input type="file" name="favicon" accept="image/*"
                                       class="mt-2 w-full rounded-2xl border bg-white px-4 py-3 text-sm">
                                <p class="mt-1 text-xs text-gray-500">Browser tab icon. Small square image works best.</p>
                            </div>
                        ...
                        <div class="rounded-3xl border bg-white p-6 space-y-4">
                            ...
                            <p class="text-xs text-gray-500">
                                If a file is empty, it will be hidden in frontend automatically (if your welcome page checks it).
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="rounded-2xl border bg-white px-4 py-3">
                            ...
                            <input type="number" name="delivery_charge"
                                   value="{{ $settings['delivery_charge'] ?? 60 }}"
                                   class="mt-1 w-full bg-transparent outline-none text-sm text-gray-900 placeholder:text-gray-400"
                                   placeholder="60">
                        </div>
