        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
            ...
            <div class="max-w-3xl mx-auto text-center">
                <span
                    ...
                    Premium Combo Products
                </span>

                <h1 class="mt-5 text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#111827] leading-[1.08]">
                    Explore Our Exclusive Combo Offers
                </h1>

                <p class="mt-5 text-sm sm:text-base leading-8 text-[#667085] max-w-2xl mx-auto">
                    Discover curated combos with premium care. Enhance your beauty and self-care routines with the finest
                    selection.
                </p>
            </div>

            @if($comboProducts->count())
                <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    @foreach($comboProducts as $product)
                        @php
                            ...
                            $giftImage = $product->gift_image ?? null; // Gift image check
                        @endphp
                        ...
                        <div
                            ...
                            <a href="{{ route('combo-products.show', $product) }}" class="block relative">
                                <div class="relative h-[320px] sm:h-[340px] md:h-[300px] lg:h-[340px] overflow-hidden bg-[#edf5ec]">
                                    ...
                                    <!-- Gift Badge -->
                                    @if($gift)
                                        <div class="absolute top-4 right-4 z-20 bg-green-600 text-white text-xs font-bold py-1 px-3 rounded-full">
                                            Gift
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="p-5 sm:p-6">
                                <div class="flex items-start justify-between gap-4">
                                    <div class="min-w-0">
                                        ...
                                        <p class="mt-2 text-sm text-gray-400">{{ $product->variant }}</p>
                                    </div>
                                ...
                                <div class="mt-6 flex flex-col gap-3">
                                    ...
                                    <button type="button"
                                        ...
                                        data-add-cart data-id="{{ $product->id }}" data-title="{{ $product->title }}"
            ...
            @else
                <div
                    ...
                    <h3 class="text-2xl font-bold text-[#111827]">No Combo Products Found</h3>
                    <p class="mt-3 text-gray-500">Please add combo products from the admin panel.</p>
                </div>
            @endif
        </div>
    </section>
